...
class ModelArguments:
    quant_model_path: Optional[str] = field(
        default="", metadata={"help": "path of the quantization model by Block-AP."}
    )
...
class TrainingArguments(transformers.Seq2SeqTrainingArguments):
    ...
    do_ppl_eval: Optional[bool] = field(
        default=False, metadata={"help": "Whether to run the PPL evaluation."}
    )
    pt_context_len: int = field(
        default=1024, metadata={"help": "language modeling length."}
    )
    full_finetune: bool = field(
        default=False, metadata={"help": "Finetune the entire model without adapters."}
    )
    wbits: int = field(default=4, metadata={"help": "How many bits to use."})
    group_size: int = field(
        default=64, metadata={"help": "How many group size to use."}
    )
    ...
    resume_from_checkpoint: str = field(
        default=None, metadata={"help": "The output dir for logs and checkpoints"}
    )
    optim: str = field(
    ...
    max_steps: int = field(
        default=0, metadata={"help": "How many optimizer update steps to take"}
    )
    ...
    save_strategy: str = field(
        default="epoch", metadata={"help": "When to save checkpoints"}
    )
